...
search_habits/
  ...
  popup/
    popup.html         The small window shown when the toolbar icon is clicked
    popup.css          Styling for that window
    popup.js           Behaviour for that window
  icons/
...
| Phase | Goal |
|-------|------|
| 0 | Project setup and a loadable extension |
| 1 | Popup UI |
